...
#endif
#ifdef _JZ_NEW_NPCCMD
BOOL NPC_CheckTime_jzmonth(int meindex,int talker,int memberp,int flg);
BOOL NPC_CheckTime_jzday(int meindex,int talker,int memberp,int flg);
BOOL NPC_CheckTime_jztime(int meindex,int talker,int memberp,int flg);
BOOL NPC_CheckTime_jzmin(int meindex,int talker,int memberp,int flg);
BOOL NPC_CheckTime_jzweek(int meindex,int talker,int memberp,int flg);
#endif
