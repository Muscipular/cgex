...
#ifdef _JZ_BEST_SAAC
int saacproto_CheckACFuncCmdInf(void);
#endif
...
void saacproto_ACFixFMPK_send(int fd, char *winfmname, int winfmindex,
        int winindex, char *losefmname, int losefmindex, int loseindex, int _flg, int _par);
...
#ifdef _JZ_VIRTUALCARD
void saacproto_QueryCardPass_send(int fd,int charaindex, char *cardpass, char *cdkey, char *charname);
void saacproto_QueryCardPass_recv(int fd,int charaindex, char *cardpass, char *cdkey, char *charname, int roleflg, int rolepar);
void saacproto_SetUseCardPass_send(int fd, char *cardpass, int flg);
void saacproto_CreateCardPass_send(int fd, int charaindex, int roleflg, int rolepar, int num);
void saacproto_CreateCardPass_recv(int fd, int charaindex, int roleflg, int rolepar, int num);
#endif

#ifdef _JZ_NEW_GMCOMMAND
void saacproto_LockAccount_send(int fd, char *_Account);
void saacproto_LockAccount_recv(int fd, char *_Account, int _flg);
void saacproto_UnLockAccount_send(int fd, char *_Account);
void saacproto_UnLockAccount_recv(int fd, char *_Account, int _flg);
#endif

#ifdef _JZ_BILLING_SYSTEM
void saacproto_QueryMPoint_send(int fd, int _charindex, char *_Account);
void saacproto_QueryMPoint_recv(int fd, int _charindex, char *_Account, int _pointnum);
void saacproto_QueryPeriod_send(int fd, int _charindex, char *_Account);
void saacproto_QueryPeriod_recv(int fd, int _charindex, char *_Account, char *_daystr);
void saacproto_IncreaseMPoint_send(int fd, int _charindex, char *_Account, char * _cardpass, int _pointnum);
void saacproto_IncreaseMPoint_recv(int fd, int _charindex, char *_Account, char * _cardpass, int _flg);
void saacproto_IncreasePeriod_send(int fd, int _charindex, char *_Account, char * _cardpass, int _daynum);
void saacproto_IncreasePeriod_recv(int fd, int _charindex, char *_Account, char * _cardpass, int _flg);
#endif

#ifdef _JZ_BEST_SAAC
int saacproto_F_S( int fd, void* AC_Func);
int saacproto_F_SS( int fd, void* AC_Func);
int saacproto_F_SSI( int fd, void* AC_Func);
int saacproto_F_SSII( int fd, void* AC_Func);
int saacproto_F_SSIII( int fd, void* AC_Func);
int saacproto_F_SSSII( int fd, void* AC_Func);
int saacproto_F_SSSSII( int fd, void* AC_Func);
int saacproto_F_SIISSII( int fd, void* AC_Func);
int saacproto_F_SISSII( int fd, void* AC_Func);
int saacproto_F_SSSIII( int fd, void* AC_Func);
int saacproto_F_SSS( int fd, void* AC_Func);
int saacproto_F_SSSSSII( int fd, void* AC_Func);
int saacproto_F_SIII_1243( int fd, void* AC_Func);
int saacproto_F_SII( int fd, void* AC_Func);
int saacproto_F_SI( int fd, void* AC_Func);
int saacproto_F_SIS( int fd, void* AC_Func);
int saacproto_F_IISISII( int fd, void* AC_Func);
int saacproto_F_SIIIIS( int fd, void* AC_Func);
int saacproto_ACFMCharLogin_recvEx( int fd, void* AC_Func);
int saacproto_F_SIIIS( int fd, void* AC_Func);
int saacproto_F_SSIIISI( int fd, void* AC_Func);
int saacproto_F_SIIS( int fd, void* AC_Func);
int saacproto_F_SISSI( int fd, void* AC_Func);
int saacproto_F_II( int fd, void* AC_Func);
int saacproto_F_SIII( int fd, void* AC_Func);
int saacproto_F_ISI( int fd, void* AC_Func);
int saacproto_F_IS( int fd, void* AC_Func);
int saacproto_F_ISS_321( int fd, void* AC_Func);
int saacproto_F_SSSII_45132( int fd, void* AC_Func);
int saacproto_F_IISS( int fd, void* AC_Func);
int saacproto_F_IISI( int fd, void* AC_Func);
int saacproto_F_IIS( int fd, void* AC_Func);
int saacproto_F_I( int fd, void* AC_Func);
int saacproto_F_SSSSSIII( int fd, void* AC_Func);
int saacproto_F_SIS_132( int fd, void* AC_Func);
int saacproto_SIISIIS( int fd, void* AC_Func);
int saacproto_F_IIIS_2134( int fd, void* AC_Func);
#endif

#ifdef _SAF_LUA_MYSQL
void saacproto_LUASQL_send(int charaindex, int row,char* sqlstr,int npcindex);
void saacproto_LUASQL_recv(int charaindex, char* result, int npcindex);
#endif
